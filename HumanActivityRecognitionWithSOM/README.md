...
Data set:
https://archive.ics.uci.edu/ml/datasets/human+activity+recognition+using+smartphones%60

This project contains:
- Data cleaning and preparation
- Checking if SOM is useful for clustering activities from this dataset.
- Conclusions
